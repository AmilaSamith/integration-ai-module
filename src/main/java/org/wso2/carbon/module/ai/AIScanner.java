...
/**
 * Mediator class that handles scanning documents with AI.
 */
public class AIScanner extends AbstractMediator {
    @Override
    public boolean mediate(MessageContext synCtx) {
        org.apache.axis2.context.MessageContext msgContext = ((Axis2MessageContext) synCtx).getAxis2MessageContext();

        try {
            AIScannerAgentModel agent = AIUtils.getAIScannerAgent(synCtx);
