...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.integration-AI-module;
 ...
 */
public class integration-AI-moduleConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "integration-AI-module test case")
